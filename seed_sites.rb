...
Site.create(
  ...
  contact: "Contact: Jaime Sevilla",
  phone: "503-213-1446",
  email: "jsevilla@stpius.org",
  url: "",
  class_resource: "Class",
  site_type: "Church",
  happening_now: "Yes",
...
Site.create(
  ...
  contact: "Kris Magaurn, Volunteer Literacy Coordinator  503-620-4613 kmagaurn@pcc.edu",
  phone: "",
...
Site.create(
  ...
  contact: "Paul Colligan 971-275-3775 (English)Rosemary Carleson 503-804-0916 (Spanish)http://tigardumc.com",
  phone: "",
  email: "",
...
Site.create(
  ...
  contact: "Contact Nanci Leiton for registration or other information at 503-716-5748"
  phone: "503-716-5748",
  email: "",
...
Site.create(
  ...
  address: "11940 SW Lynnefield Ln.",
  city:"Cedar Hills",
  state:"OR",
  zip:"",
...
Site.create(
  ...
  address: "2215 NE 104th St.",
  city: "Vancouver",
  state: "WA",
  zip: "",
  description: "Multilevel, Free, Child care available.Monday and Wednesday evenings from 6:00-8:30.",
  contact: "Call Sarah J. Anderson Elementary for more information: 360-313-1500",
  phone: "360-313-1500",
  email: "",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  phone: "(503) 384-2482",
  email: "Jaymee Martin jmartin@emoregon.org",
...
Site.create(
  ...
  address: "18878 SW Martinazzi Ave",
  city: "Tualatin",
  state: "OR",
  zip: "97062",
  ...
  contact: "(503) 691-3072 librarymail@ci.tualatin.or.us",
  phone: "(503) 691-3072",
...
Site.create(
  ...
  address: "12375 Southwest 5th Street",
  city: "Beaverton",
  state: "OR",
  zip: "",
...
Site.create(
  ...
  contact: "Application available online.Co-directors: Laura Shier and Joann GeddesPhone: 503-768-7310",
  phone: "",
  email: "",
...
Site.create(
  ...
  contact: "Allison Burns Merlo Station Apartments T 503.746.6346, MerloStation@gres.com",
  phone: "",
  email: "MerloStation@gres.com",
  url: "",
  class_resource: "Class",
  site_type: "Social Service/Government/Non-Profit",
  happening_now: "Yes",
...
Site.create(
  ...
  address: "526 SE 9th Ave",
  city: "Hillsboro",
  state: "OR",
  zip: "97123",
  description: "English Classes For Adults Beginners to Intermediate; Childcare provided; Registration: $15     Books $32; Registration & Classes from 6:30 to 8:30 PM; Fall  Semester 2015 Registration Tuesday and Thursday, Sept. 8 & 10 26 classes, Tuesdays and Thursdays Sept. 15-Dec. 17; Clases de Inglés Para Adultos Principiantes hasta intermedianos; Con cuidado de niños; Inscripción: $15     Libros: $32;Inscripción y clases de 6:30 a 8:30 PM; Otoño 2015 Inscripción martes y jueves, 8 y 10 de septiembre 26 clases, martes y jueves Del 15 de septiembre al 17 de diciembre;",
...
Site.create(
  ...
  contact: "Call 503.384.2482 for more information, or find us at facebook.com/SOARLegal",
  phone: "503.384.2482",
  email: "",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  contact: "Jeanne Stephens: jmorsestephens@gmail.com 360-696-0181",
  phone: "",
...
Site.create(
  ...
  contact: "To enroll, call Tammara at 424-295-6300 or write an email to EnglishClasses@TeachingHouse.com with the subject “Los Angeles",
  phone: "",
...
Site.create(
  ...
  address: "11105 NW Lakeshore Ave",
  city: "Vancouver",
  state: "WA",
  zip: "",
...
Site.create(
  ...
  state: "WA",
  zip: "",
  description: "Multiple Classes, $25, Register quarterly Take placement test before registeringhttp://www.clark.edu/academics/transitional-ed/esl.php",
  contact: "",
  phone: "",
  email: "",
...
Site.create(
  ...
  address: "5411 East Mill Plain Blvd.",
  city: "Vancouver",
  state: "WA",
  zip: "",
...
Site.create(
  ...
  address: "6425 NE Fourth Plain Blvd.",
  city: "Vancouver",
  state: "WA",
  zip: "98661",
  description: "Free. Open entry classes. Monday and Wednesdays. 9:00-11:00.Citizenship Class 2:00-3:30 Tuesdays.",
  contact: "Call Instructor Margaret Ellis (503)238-6129  English and на русскомOr the Vancouver Goodwill Industries Job Connection office at 360-695-1923 English only.",
  phone: "",
  email: "",
...
Site.create(
  ...
  address: "3201 NE 52nd St.",
  city: "Vancouver",
  state: "WA",
  zip: "",
  description: "Clark College ESL Class LocationClass times vary",
  contact: "http://www.partnersincareers.org/programs.html 360 696 8417",
  phone: "360 696 8417",
  email: "",
...
Site.create(
  ...
  address: "15555 SW 98th Ave",
  city: "Tigard",
  state: "OR",
  zip: "97224",
  description: "Wednesdays at 7:00pm-7:30pm Miércoles a las 7:00pm-7:30pm",
  contact: "For more information or to attend a class, please contact an elder/ Para más información o para asistir un clase, por favor llame a un elder al número: 503-752-5580",
  phone: "",
  email: "",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  address: "1049 SW Baseline St Suite D440",
  city: "Hillsboro",
  state: "OR",
  zip: "97123",
  ...
  contact: "Oficina/Office- (971) 228-8462 Todd Stout - tstout@or.easterseals.org",
  phone: "(971) 228-8462",
...
Site.create(
  ...
  contact: "Nena Monterroza Spanish speaker at 503-594-3234.Marina Drozdova (Russian speaker) at 503-594-0647. Molly Burns 503-594 0633.",
  phone: "",
  email: "",
...
Site.create(
  ...
  contact: "Register at the Front Reception Desk or call David C. 503-238-6173. or Aaron S. 503-238-6196.",
  phone: "", 
  email: "",
...
Site.create(
  ...
  contact: "missioncitizen@gmail.com www.missioncitizen.org 503-765-6867",
  phone: "503-765-6867",
  email: "missioncitizen@gmail.com",
  url: "www.missioncitizen.org",
  class_resource: "Class",
...
Site.create(
  ...
  state: "OR",
  zip: "",
  description: "October 4 - November 22, 2016Tuesday & Thursday. 5:30-7:30pm.Room B-6 Marshall HS: 3905 SE 91st Ave. 97266. Free. Open-Entry.",
  contact: "",
  phone: "",
  email: "",
...
Site.create(
  ...
  address: "1900 SE 117th Ave",
  city: "Portland",
  state: "OR",
  zip: "",
  description: "Monday & Wednesday, 6:00-7:30 pm (March 31 – May 21)",
  contact: "Bryant Royal -Campfire Columbiabryant_royal@ddouglas.k12.or.us Nicole Brown -Center for Intercultural Organizing nicole@interculturalorganizing.org",
  phone: "",
...
Site.create(
  ...
  contact: "Contact: Blair Orfall, Volunteer Resources Specialist: 503-772-2341 borfall@seworks.org http://www.seworks.org",
  phone: "", 
...
Site.create(
  ...
  zip: "97232",
  description: "Tuition Based Program",
  contact: "Call 503-226-1656 for more information http://www.portlandenglish.edu/",
  phone: "503-226-1656",
  email: "",
...
Site.create(
  ...
  state: "OR",
  zip: "",
  description: "ESL Classes Client Referral Only",
  contact: "(503) 943-2000 Call PCC Main Campus for ESL open to public: (971) 722-5747",
  phone: "(503) 943-2000",
  email: "",
  url: "",
  class_resource: "Resource",
...
Site.create(
  ...
  state: "OR",
  zip: "97060",
  description: "Classes meet every Wednesday April 1 - May 27, 20156:30 - 8:00 PM Class is free. Multi-Level Class. Students can register at the first class and enter the class at any time until class fills up. No Childcare.",
  contact: "Elvira Quintero Nanbu; ELL/Translator 503-667-3186 Ext. 1052 EQuintero@rsd7.net",
  phone: "",
...
Site.create(
  ...
  address: "240 NE Martin Luther King Jr. Blvd.",
  city: "Portland",
  state: "OR",
  zip: "",
  description: "Free, Multilevel, Open Entry, Volunteers Welcome.Class days and times vary.",
  contact: "503-233-6787 Volunteer Coordinator: volunteercoordinator@portlandvoz.org",
  phone: "503-233-6787",
  email: "volunteercoordinator@portlandvoz.org",
...
Site.create(
  ...
  contact: "503-660-1440. Contact for days and times. Register at www.worksourceportlandmetro.org .",
  phone: "503-660-1440",
  email: "",
...
Site.create(
  ...
  contact: "Contact Sarah Keeney for more information. Ph: 971-722-5373 and sarah.keeney@pcc.edu",
  phone: "",
...
Site.create(
  ...
  contact: "Information:Español 503-491-7675 English 503-491-7333 http://www.mhcc.edu",
  phone: "503-491-7333",
  email: "",
...
Site.create(
  ...
  contact: "Reid Craig reidc@multcolib.org 503-988-5396. https://multcolib.org/library-location/rockwood",
  phone: "503-988-5396",
...
Site.create(
  ...
  contact: "Travis Richardson, SUN program associate 503-408-2640 travis.richardson@portlandoregon.gov",
  phone: "",
...
Site.create(
  ...
  address: "5520 NE Killingsworth",
  city: "Portland",
  state: "OR",
  zip: "",
  description: "We meet Thursdays from 7:00 - 8:30 PM.  We offer: Beginning Class Intermediate Class Children's Bible Story Class for school age children. Childcare for younger children. There is no charge. Fall classes began September 15th, 2016.",
...
Site.create(
  name: "Educate Ya",
  address: "200 NE 20th Ave, Ste. 10",
  city: "Portland",
  state: "OR",
  zip: "",
...
Site.create(
  ...
  contact: "Domminick McParland dmcparland@lcsnw.org (503) 231-7480  Ex. 585",
  phone: "(503) 231-7480  Ex. 585",
...
Site.create(
  ...
  contact: "oakinjiola@awcportland.org 503.972.4930",
  phone: "503.972.4930",
...
Site.create(
  ...
  contact: "503-974-9882 losninoscuentan@gmail.com",
  phone: "503-974-9882",
...
Site.create(
  ...
  address: "13793 SE Sieben Park Way",
  city: "Clackamas",
  state: "OR",
  zip: "97015",
  ...
  contact: "503-783-3455 dougj@happyvalleyor.gov",
  phone: "503-783-3455",
...
Site.create(
  ...
  contact: "Nena Monterozza (Spanish speaker) at 503-594-3234 or Gloria Castaneda 503-594 3233",
  phone: "",
  email: "",
  url: "http://www.clackamas.edu/ESL/",
  class_resource: "Class",
...
Site.create(
  ...
  contact: "michelle@cs.edu 503.775.8983",
  phone: "503.775.8983",
...
Site.create(
  ...
  contact: "Amy Trieu, SUN site Manager amyt@metfamily.org 503.262.4408 General Office Number:  503-262-4431",
  phone: "503-262-4431",
...
Site.create(
  ...
  address: "12625 SW Broadway, Suite 200",
  city: "Beaverton",
  state: "OR",
  zip: "97005",
...
Site.create(
  ...
  address: "12375 S.W. Fifth Street",
  city: "Beaverton",
  state: "OR",
  zip: "97005",
...
Site.create(
  ...
  contact: "Contact: Kristyn KidneyPhone: 503-251-6412 Email: kkidney@multnomah.edu",
  phone: "",
...
Site.create(
  ...
  contact: "Blair Orfall - IRCO Workplace ESL Instructor borfall@seworks.org 503-722-2341",
  phone: "",
  email: "borfall@seworks.org",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  contact: "Please contact the SOAR office for more information: 503-384-2482 (extension 116)or www.facebook.com/SOARLegal",
  phone: "503-384-2482 ext. 116",
  email: "",
...
Site.create(
  name: "Easter Seals of Oregon Latino Connection Program",
  address: "2951 NW Division Street., Suite 142",
  city: "Gresham",
  state: "OR",
  zip: "97030",
...
Site.create(
  ...
  contact: "Contact: Will Reese 503-916-5904",
  phone: "",
  email: "",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  address: "8815 NE Glisan St.",
  city: "Portland",
  state: "OR",
  zip: "97220",
  description: "",
  contact: "503-252-1424 x123",
  phone: "503-252-1424 x123",
  email: "",
  url: "",
  class_resource: "Class",
  site_type: "Church",
...
Site.create(
  ...
  state: "OR",
  zip: "97220",
  description: "Adult ESL Classes: April 4th- May 25th Mondays & Wednesdays, 5:30-7:30pm, Classes are FREE and open to the public. No pre-registration required, new students always welcome. No childcare provided for Spring Session.",
...
Site.create(
  ...
  contact: "Amber McGill: 971-570-1384 (text or call) or, amcgill@impactnw.org",
  phone: ""
...
Site.create(
  ...
  contact: "Carrie Hardison - chardison@impactnw.org Phone: 503-762-6180",
  phone: "",
