...
Site.create(
  ...
  address: "15811 SE Main St. Portland, OR",
  city:,
  state:,
  zip:,
  ...
  contact: "SUN Program Coordinator- Metropolitan Family Service. Genevieve
  phone: "", Blaettler 503.762.7278.",
  email: "",
  url: "",
  class_resource: "Class",
  site_type: "Public School",
...
Site.create(
  ...
  address: "2305 SE 82nd Portland, OR 97216",
  city:,
  state:,
  zip:,
  ...
  contact: "Outreach and Intake Coordinator: pccprep@pcc.edu or
  phone: "", 971-722-6213In Portland area: Esperanza Beck (Spanish-speaking) 971-722-6231Mathilda Lee (Chinese-speaking) 971-722-6110 http://www.pcc.edu/prepare/head-start/prep/map/Emma Zwaschka (Russian-speaking) 971-722-6029In Washington County: Vanessa Hernandez (Spanish-speaking) 971-722-2915",
...
Site.create(
  ...
  contact: "Contact: Kathleen Holloway, Volunteer Tutor Coordinator:
  phone: "", 971-722-6280khollowa@pcc.edu",
...
Site.create(
  ...
  state:,
  zip:,
  description: "Free one-on-one and small group tutoring for ESL and possibly CitizenshipYear-round program",
...
Site.create(
  ...
  address: "447 SE 3rd Ave, Hillsboro, OR 97123",
  city:,
  state:,
  zip:,
  ...
  contact: "Tracy Buseman-Carlstrom971-722-2516",
  phone: "",
  email: "",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  address: "372 NE Lincoln, Hillsboro, OR",
  city:,
  state:,
  zip:,
...
Site.create(
  ...
  address: "1410 SE Hawthorne Blvd Portland, OR 97214",
  city:,
  state:,
  zip:,
...
Site.create(
  ...
  address: "527 SW Hall Street University Center Building, Suite 400 Portland, OR 97201",
  city:,
  state:,
  zip:,
  description: "Full-time, tuition based program",
  contact: "See website for details http://ielp.pdx.edu or call
  phone: "", 503-725-4088 Email: ielpadm@pdx.eduhttp://ielp.pdx.edu",
...
Site.create(
  ...
  address: "4440 SW 148th Ave. Beaverton, OR 97007",
  city:,
  state:,
  zip:,
...
Site.create(
  ...
  address: "9905 SW Mckenzie, Tigard, OR",
  city:,
  state:,
  zip:,
  description: "4 Levels, Free, 10 Week termsNo childcare. Open registration: Come 15 minutes early for placement testing and registration. Tuesday & Thursday evenings 7:00 to 8:30Located behind Parish Office. WINTER 2016: January 4-March 18SPRING 2016: March 28–June 10",
  contact: "Marco Espinoza 503-639-4179 ext.129Derene & Bob Meurisse
  phone: "", 503-590-5582",
  email: "",
  url: "",
  class_resource: "Class",
...
Site.create(
  ...
  address: "11265 SW Cabot, Beaverton, OR",
  city:,
  state:,
  zip:,
  description: "ESL Classes, Free ChildcareThursdays 6:45 pm-8:30pm 4 Levels.  $5 registration fee, register at class (come at 6:30 for registration and testing on your first day). Registration is ongoing.Winter term will start Thursday, January 14th.Terms follow PCC dates.",
...
Site.create(
  ...
  state:,
  zip:,
  description: "Multilevel, FreeThursday MorningsNo registration needed",
...
Site.create(
  ...
  state:,
  zip:,
  description: "3 Levels, $30 fee includes book (fee may be minimized/waved due to late entry into the program), Open-entry, Child Care for ages 3yrs and upTuesday and Thursday nights 7:00pm-8:30pmRegister in class.",
