...
Site.create(
  ...
  state: "OR",
  zip: "97031",
  description: "Winter term- January 9th- March 23rd 2012Level A & BTuesday and Thursday 8:00-11:00 amTuesdays and Thursdays 6:00-9:00 pmLevel C & DMonday and Wednesday 8:00-11:00 amTuesdays and Thursdays 6:00-9:00 pm",
  contact: "",
...
Site.create(
  ...
  state: "OR",
  zip: "97123",
  description: "ESL (including Rosetta Stone and help paying for classes at PCC), job training, and employment information For people who have worked in farmwork in the last two years and their dependents. ESL classes in conjunction with Goodwill and open to the community, all levels and all languages.Tuesdays 1:30-3:00Please call just to say you're coming. Year-round program.",
...
Site.create(
  ...
  state: "WA",
  zip: "98660",
  description: "Multilevel, Free, Open-entryEnglish Conversation CircleTuesdays 2:00-3:30pm",
...
Site.create(
  ...
  state: "OR",
  zip: "",
  description: "Talk Time - English Conversation PracticeMultilevel, Free, Ongoing:  Wednesdays 5:30-7:00",
  contact: "",
  phone: "503-988-5123",
  email: "",
